    ...
    $.getJSON("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson", function (data) {
        ...
        if (document.body.classList.contains("portada")) {
            data.features.forEach(function (temblor, i) {
                ...
                $("section").append(articuloTipo + "<h2>" + temblor.properties.mag + "</h2><p>" + temblor.properties.place + "</p><p>" + new Date(temblor.properties.time).toLocaleDateString('es-CL',{year: 'numeric', month: 'long', day: 'numeric', hour: 'numeric', minute: 'numeric', second: 'numeric'}) + "</p><p><a href='page.html?temblor=" + i + "'>ver mapa</a></p></article>");
            });
            var valor;
            ...
            if (t !== null) {
                ...
                circle = L.marker([latitud, longitud], {icon: icono})
                    .addTo(elmapa)
                    .on("click", vinculo);
                function vinculo() {
